...
public class Wildernis {
    ...
    /**
     * Goes through a given grass cell's neighbours (adjacent and diagonal), and adds the given cel to it's
     * neighbour's list of observers if it's a grass object
     * @param v The grass cel
     * @param x
     * @param y
     */
